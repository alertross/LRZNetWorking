...
@interface LRZCacheManager ()
@property (nonatomic ,copy)NSString *diskCachePath;
@property (nonatomic ,strong) dispatch_queue_t operationQueue;

@end

@implementation LRZCacheManager

+ (LRZCacheManager *)sharedInstance{
    static LRZCacheManager *cacheInstance=nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        cacheInstance = [[LRZCacheManager alloc] init];
    });
...
- (id)init{
    ...
    if (self) {
        ...
        _operationQueue = dispatch_queue_create("com.dispatch.LRZCacheManager", DISPATCH_QUEUE_SERIAL);
